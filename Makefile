# This Makefile is for the GoXML::XQI extension to perl.
#
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/GoXML
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/GoXML
...
manifypods : pure_all XQI.pm
	@$(POD2MAN) \
	XQI.pm \
	$(INST_MAN3DIR)/GoXML::XQI.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"GoXML-XQI\" VERSION=\"1,1,3,0\">\n}. qq{\t<TITLE>GoXML-XQI</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > GoXML-XQI.ppd
